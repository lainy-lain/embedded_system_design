...
// DC모터 속도 관련 상수 (실험 후 수정)
#define DC_SPEED_FAST 0xFFFE
#define DC_SPEED_SLOW 0x00FF
// 서보모터 회전각 관련 상수 (실험 후 수정)
...
// 운행 명령어 목록 (char여야 함. 추후 수정)
#define OP_GO_FORWARD           'q'
#define OP_GO_FORWARD_LEFT      'w'
#define OP_GO_FORWARD_RIGHT     'e'
#define OP_GO_BACKWARD          'a' 
#define OP_GO_BACKWARD_LEFT     's'
...
void setDCMotor_goFoward(void) {
    ...
    // 뒷부분
    GPIO_SetBits(GPIOD, GPIO_Pin_8 | GPIO_Pin_12);
    GPIO_ResetBits(GPIOD, GPIO_Pin_10 | GPIO_Pin_14);
...
void setDCMotor_goBackward(void) {
    ...
    // 뒷부분
    GPIO_ResetBits(GPIOD, GPIO_Pin_8 | GPIO_Pin_12);
...
void setDCMotor_stop(void) {
    ...
    // 뒷부분
    GPIO_ResetBits(GPIOD, GPIO_Pin_8 | GPIO_Pin_10 | GPIO_Pin_12 | GPIO_Pin_14);
